...
myfinpro currently contains *only* foundation code (auth, users, groups, timezone, i18n, deployment) with zero finance-domain coupling — verified by inspection. Everything below ports cleanly.
